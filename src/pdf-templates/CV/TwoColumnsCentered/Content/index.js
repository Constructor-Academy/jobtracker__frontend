...
const Content = ({user}) => {
    ...
    return (
        <View style={styles.page_right}>
            ...
            {Boolean(user.educations.length) && <ExperienceList icon={educationIcon} isLastCategory={!hasCategories} list={user.educations} title={t('profile:cv_gen:content.education')} />}
            {
