...
const ElegantGraphic = ({user, application, job, contact, company, mainColor, fontColor}) => {
    ...
    return (
        <Page size="A4" style={style.page}>
            <Stripes containerStyles={style.stripes_top} mainColor={mainColor} />
            ...
            <Stripes containerStyles={style.stripes_bottom} mainColor={mainColor} />
        </Page>
    )
}

export default ElegantGraphic
